...
class LikePolicy
{
    ...
    {
        return $user->can('force_delete_like');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Like $like)
    {
        return $user->can('replicate_like');
    }
